...
export default {
  ...
  DS_DEMARCHE_NUMBER: process.env.DS_DEMARCHE_NUMBER
    ...
    : null,
  DS_DEMARCHE_RENOUVELLEMENT_BADGE_NUMBER: process.env
    .DS_DEMARCHE_RENOUVELLEMENT_BADGE_NUMBER
    ? parseInt(process.env.DS_DEMARCHE_RENOUVELLEMENT_BADGE_NUMBER)
    : null,
  EMAIL_DEFAULT_PLAN:
