...
export default {
  ...
  DS_DEMARCHE_NUMBER: process.env.DS_DEMARCHE_NUMBER ? parseInt(process.env.DS_DEMARCHE_NUMBER) : null,
  ...
  MATTERMOST_PARTNERS_AUTHORS_URLS: process.env.MATTERMOST_PARTNERS_AUTHORS_URLS ? JSON.parse(process.env.MATTERMOST_PARTNERS_AUTHORS_URLS) : [],
  ...
  FEATURE_MATTERMOST_REMOVE_USERS: process.env.FEATURE_MATTERMOST_REMOVE_USERS === 'true',
  ...
  FEATURE_SIB_USE_UPDATE_CONTACT_EMAIL: process.env.FEATURE_SIB_USE_UPDATE_CONTACT_EMAIL === 'true',
  FEATURE_SEND_EMAIL_TO_STARTUP_TO_UPDATE_PHASE: process.env.FEATURE_SEND_EMAIL_TO_STARTUP_TO_UPDATE_PHASE === 'true',
